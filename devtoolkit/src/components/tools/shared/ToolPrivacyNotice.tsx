...
function ToolPrivacyNotice({
  ...
  return (
    <div className="flex items-start gap-2.5 rounded-xl border border-[var(--success)]/15 bg-[var(--success)]/5 px-4 py-3 text-xs leading-5 text-[var(--muted)] transition-colors">
      <span
        aria-hidden="true"
